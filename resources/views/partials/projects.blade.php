    ...
    <div class="container">
        ...
        $projects = [
            [
                ...
                'desc'   => 'A Landing page for a digital agency, showcasing their services, contact form and highlighting their product with AR Mode and 3D models.',
            ...
            [
                ...
                'title'  => 'OOP WEB API',
                'type'   => 'SaaS REST API',
                'desc'   => 'A multi-tenant SaaS API platform with Laravel Sanctum authentication, rate limiting, webhooks, and developer-friendly documentation.',
            ...
            [
                ...
                'desc'   => 'A full-featured digital library management system built with Laravel 12, MySQL, and Bootstrap 5.',
